...
--              {description = "show main menu", group = "awesome"}),
    ...
    -- Custome application launcher 
    awful.key({ modkey},	    "q", function () awful.util.spawn("vimb --no-maximize") end,
	{description = "open a web browser", group = "launcher"}),
    awful.key({modkey},		    "c", function () awful.spawn("code") end,
	{description = "open a new vscode space", group = "launcher"}),

    -- Taking screenshot
    awful.key({ modkey, "Shift" }, "s", function () awful.util.spawn_with_shell("import png:- | xclip -sel clip -t image/png") end,
 	{description = "take area/window ss", group = "misc."}),
    awful.key({ modkey, "Control" }, "s", function () awful.util.spawn_with_shell("import -window root ~/Documents/Screenshot/`date +%Y%b%dT%H%M`.png") end,
 	{description = "take entire screen ss", group = "misc."}),

    -- Checking class name
    awful.key({ modkey},	    "i", function () awful.util.spawn_with_shell("xprop | grep -i 'class' | xclip -sel clip") end,
	{description = "check program's class name", group = "misc."}),
